...
let ScienceBook = Object.create(bookPrototype);
...
const desc = Object.getOwnPropertyDescriptor(ScienceBook, "info");
...
let Textbook = {};
Object.setPrototypeOf(Textbook, ScienceBook);
...
// | author      | "Дж. Д. Джонс"             |
ScienceBook.title = "Фізика у Вищій Школі";
ScienceBook.author = "Дж. Д. Джонс";
...
const Media = Object.create(mediaPrototype);
/*
 * Об'єкт: Song
